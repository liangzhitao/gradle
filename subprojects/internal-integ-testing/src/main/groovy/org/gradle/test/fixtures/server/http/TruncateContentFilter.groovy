...
class TruncateContentFilter implements Filter {
    private static final String HTTP_METHOD_PUT = "PUT"
    private static final String HTTP_METHOD_GET = "GET"
    private static final String HTTP_METHOD_DELETE = "DELETE"
    private FilterConfig filterConfig
    private final long truncateContentAfterPutBytes
    private final HttpBuildCacheServer buildCache

    TruncateContentFilter(long truncateContentAfterPutBytes, HttpBuildCacheServer buildCache) {
        this.truncateContentAfterPutBytes = truncateContentAfterPutBytes
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            IO.copy(ByteStreams.limit(stream, truncateContentAfterPutBytes), out)
            // Read stream fully
            def remaining = IO.readBytes(stream).length
            stream.close()
        }
        finally {
            out.close()
